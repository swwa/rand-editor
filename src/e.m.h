...
struct loopflags {
    char clear;         /* clear enterwin  */
    char hold;          /* hold cmd line until next key input */
    char beep;          /* beep on clearing cmd line */
    char flash;         /* bullet at cursor position is to be temporarily */
    char bullet;        /* redo all border bullets */
};
