...
*/
#endif
#define RECOVERMSG  "/usr/local/etc/recovermsg"
void
dorecov (type)
Reg3 int type;
{
...
gettermtype ()
{
    ...
    move  ((char *)tterm[termtype], (char *)&term, sizeof(S_term));
    move  ((char *)tkbd[kbdtype], (char *)&kbd, sizeof(S_kbd));
...
#   endif CBREAK;
    ...
    BITS(temp_termio.c_iflag,
	 IGNPAR,
	 ISTRIP|IGNBRK|BRKINT|PARMRK|INPCK|INLCR|IGNCR|ICRNL|IUCLC|IXOFF
	);
