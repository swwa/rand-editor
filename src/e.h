...
#define LMCLDC          /* Tcap.c uses line drawing defs for windows */
...
#define LOGINNAME "E"
/* fine CLEARONEXIT          /* if defined, clears screen on exit    */
/* fine DEBUGDEF                /* misc debugging stuff                 */
...
#define CTRLCHAR   (key < 040 || 0177 <= key && 0232 > key)
